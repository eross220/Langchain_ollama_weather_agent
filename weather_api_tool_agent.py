...
from tools import get_geo_data_from_city_or_zip_tool, get_weather_tool, get_local_datetime_tool
...
if username and OPENAI_API_KEY.startswith('sk-'):
    ...
    # tools = [get_geo_data_from_city_or_zip_tool(), get_local_datetime_tool(), get_weather_tool()]
    
    tools = [get_geo_data_from_city_or_zip, get_local_datetime,get_weather]
    llm_with_tools = llm.bind_tools(tools)
    
    # llm = ChatOllama(model="llama3.1", base_url="https://llm.i-it.pro")    
